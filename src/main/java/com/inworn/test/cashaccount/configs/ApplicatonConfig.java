package com.inworn.test.cashaccount.configs;

import com.inworn.test.cashaccount.auth.CustomUserDetails;
...
public class ApplicatonConfig {
    ...
    public ApplicatonConfig(UserRepository userRepository) {
